...
require 'i18n_yaml_editor/rewriter/rename_key'
require 'i18n_yaml_editor/rewriter/rename_key_runner'
require 'i18n_yaml_editor/rewriter/extract_string'
require 'i18n_yaml_editor/rewriter/extract_string_runner'
